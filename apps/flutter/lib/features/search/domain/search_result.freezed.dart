...
mixin _$SearchResult {
 ...
 String get id; String get title; String? get notes; DateTime? get dueDate; String? get listId; String? get sectionId; String? get parentTaskId; int get position; TimeWindow? get timeWindow; String? get timeWindowStart; String? get timeWindowEnd; EnergyRequirement? get energyRequirement; TaskPriority? get priority; RecurrenceRule? get recurrenceRule; int? get recurrenceInterval; List<int>? get recurrenceDaysOfWeek; String? get recurrenceParentId; DateTime? get archivedAt; DateTime? get completedAt; DateTime get createdAt; DateTime get updatedAt; int? get durationMinutes; DateTime? get scheduledStartTime;// Search-specific enrichment
 String? get listName;
...
as DateTime?,listName: freezed == listName ? _self.listName : listName // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? notes,  DateTime? dueDate,  String? listId,  String? sectionId,  String? parentTaskId,  int position,  TimeWindow? timeWindow,  String? timeWindowStart,  String? timeWindowEnd,  EnergyRequirement? energyRequirement,  TaskPriority? priority,  RecurrenceRule? recurrenceRule,  int? recurrenceInterval,  List<int>? recurrenceDaysOfWeek,  String? recurrenceParentId,  DateTime? archivedAt,  DateTime? completedAt,  DateTime createdAt,  DateTime updatedAt,  int? durationMinutes,  DateTime? scheduledStartTime,  String? listName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchResult() when $default != null:
return $default(_that.id,_that.title,_that.notes,_that.dueDate,_that.listId,_that.sectionId,_that.parentTaskId,_that.position,_that.timeWindow,_that.timeWindowStart,_that.timeWindowEnd,_that.energyRequirement,_that.priority,_that.recurrenceRule,_that.recurrenceInterval,_that.recurrenceDaysOfWeek,_that.recurrenceParentId,_that.archivedAt,_that.completedAt,_that.createdAt,_that.updatedAt,_that.durationMinutes,_that.scheduledStartTime,_that.listName);case _:
  return orElse();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,notes,dueDate,listId,sectionId,parentTaskId,position,timeWindow,timeWindowStart,timeWindowEnd,energyRequirement,priority,recurrenceRule,recurrenceInterval,const DeepCollectionEquality().hash(_recurrenceDaysOfWeek),recurrenceParentId,archivedAt,completedAt,createdAt,updatedAt,durationMinutes,scheduledStartTime,listName]);
