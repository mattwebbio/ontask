...
mixin _$TaskDto {
 ...
 String get id; String get title; String? get notes; String? get dueDate; String? get listId; String? get sectionId; String? get parentTaskId; int get position; String? get archivedAt; String? get completedAt; String get createdAt; String get updatedAt;
...
@override
String toString() {
  return 'TaskDto(id: $id, title: $title, notes: $notes, dueDate: $dueDate, listId: $listId, sectionId: $sectionId, parentTaskId: $parentTaskId, position: $position, archivedAt: $archivedAt, completedAt: $completedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String title, String? notes, String? dueDate, String? listId, String? sectionId, String? parentTaskId, int position, String? archivedAt, String? completedAt, String createdAt, String updatedAt
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? notes,  String? dueDate,  String? listId,  String? sectionId,  String? parentTaskId,  int position,  String? archivedAt,  String? completedAt,  String createdAt,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TaskDto():
return $default(_that.id,_that.title,_that.notes,_that.dueDate,_that.listId,_that.sectionId,_that.parentTaskId,_that.position,_that.archivedAt,_that.completedAt,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? notes,  String? dueDate,  String? listId,  String? sectionId,  String? parentTaskId,  int position,  String? archivedAt,  String? completedAt,  String createdAt,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TaskDto() when $default != null:
return $default(_that.id,_that.title,_that.notes,_that.dueDate,_that.listId,_that.sectionId,_that.parentTaskId,_that.position,_that.archivedAt,_that.completedAt,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _TaskDto extends TaskDto {
  const _TaskDto({required this.id, required this.title, this.notes, this.dueDate, this.listId, this.sectionId, this.parentTaskId, required this.position, this.archivedAt, this.completedAt, required this.createdAt, required this.updatedAt}): super._();
