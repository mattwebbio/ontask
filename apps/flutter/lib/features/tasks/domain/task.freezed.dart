...
// URL to the proof media (photo/video/doc) — null when no retained proof.
 ...
 bool get proofRetained;// Display name of the member who completed this task; null when incomplete or unknown.
...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,notes,dueDate,listId,sectionId,parentTaskId,position,timeWindow,timeWindowStart,timeWindowEnd,energyRequirement,priority,recurrenceRule,recurrenceInterval,const DeepCollectionEquality().hash(_recurrenceDaysOfWeek),recurrenceParentId,startedAt,elapsedSeconds,archivedAt,completedAt,createdAt,updatedAt,durationMinutes,scheduledStartTime,assignedToUserId,listName,proofMode,proofModeIsCustom,proofMediaUrl,proofRetained,completedByName,stakeAmountCents]);
