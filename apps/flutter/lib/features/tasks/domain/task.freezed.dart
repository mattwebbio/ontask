...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,notes,dueDate,listId,sectionId,parentTaskId,position,timeWindow,timeWindowStart,timeWindowEnd,energyRequirement,priority,recurrenceRule,recurrenceInterval,const DeepCollectionEquality().hash(_recurrenceDaysOfWeek),recurrenceParentId,startedAt,elapsedSeconds,archivedAt,completedAt,createdAt,updatedAt,durationMinutes,scheduledStartTime,assignedToUserId,listName,proofMode,proofModeIsCustom,proofMediaUrl,proofRetained,completedByName]);
