...
mixin _$Task {
 ...
 String get id; String get title; String? get notes; DateTime? get dueDate; String? get listId; String? get sectionId; String? get parentTaskId; int get position; TimeWindow? get timeWindow; String? get timeWindowStart; String? get timeWindowEnd; EnergyRequirement? get energyRequirement; TaskPriority? get priority; RecurrenceRule? get recurrenceRule; int? get recurrenceInterval; List<int>? get recurrenceDaysOfWeek; String? get recurrenceParentId; DateTime? get startedAt; int? get elapsedSeconds; DateTime? get archivedAt; DateTime? get completedAt; DateTime get createdAt; DateTime get updatedAt; int? get durationMinutes; DateTime? get scheduledStartTime; String? get assignedToUserId; String? get listName;// Proof mode for this task (FR20). Defaults to standard (no proof required).
 ProofMode get proofMode;// True when this task has a user-set proof mode override (differs from list/section default).
 bool get proofModeIsCustom;// Proof visibility fields (FR21, Story 5.5)
// URL to the proof media (photo/video/doc) — null when no retained proof.
 String? get proofMediaUrl;// True when the user chose "Keep as completion record" (FR38, Story 7.7).
 bool get proofRetained;// True when a verification dispute is pending operator review (FR39, Story 7.8).
 bool get proofDisputePending;// Display name of the member who completed this task; null when incomplete or unknown.
 String? get completedByName;// Commitment stake amount in cents; null = no stake set (FR22, Story 6.2).
 int? get stakeAmountCents;
...
as DateTime?,assignedToUserId: freezed == assignedToUserId ? _self.assignedToUserId : assignedToUserId // ignore: cast_nullable_to_non_nullable
...
as ProofMode,proofModeIsCustom: null == proofModeIsCustom ? _self.proofModeIsCustom : proofModeIsCustom // ignore: cast_nullable_to_non_nullable
...
as bool,proofDisputePending: null == proofDisputePending ? _self.proofDisputePending : proofDisputePending // ignore: cast_nullable_to_non_nullable
...
@override
int get hashCode => Object.hashAll([runtimeType,id,title,notes,dueDate,listId,sectionId,parentTaskId,position,timeWindow,timeWindowStart,timeWindowEnd,energyRequirement,priority,recurrenceRule,recurrenceInterval,const DeepCollectionEquality().hash(_recurrenceDaysOfWeek),recurrenceParentId,startedAt,elapsedSeconds,archivedAt,completedAt,createdAt,updatedAt,durationMinutes,scheduledStartTime,assignedToUserId,listName,proofMode,proofModeIsCustom,proofMediaUrl,proofRetained,proofDisputePending,completedByName,stakeAmountCents]);
